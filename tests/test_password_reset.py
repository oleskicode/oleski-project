...
def test_password_reset(playwright: Playwright) -> None:
    ...
    expect(page.locator("#qa-forget-restore")).to_match_aria_snapshot("- link \"Forgot your password?\"")
    ...
    expect(page.get_by_role("main")).to_contain_text("We already sent you an email. Please check your E-mail")
